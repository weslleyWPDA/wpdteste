...
<head>
    ...
    <style media="screen">
        .fundodapagina{
            background: -webkit-linear-gradient(#FF4500, #000000);
        }
    </style>
</head>
<!-- END: Head-->
                                ...
                                <div class="card rounded-0 mb-0 px-2">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body pt-1">
                                            <form action="validacao.php" method="post">
                                                ...
                                                <button type="submit" onclick="saveSenha()" class="bnt btn-primary btn-block">Entrar</button>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="login-footer">
                                        ...
                                        <center><a href="./admin" class="btn btn-outline-danger mr-1 mb-1 waves-effect waves-light"><i class="fa fa-user-circle" aria-hidden="true"></i></a></center>
                                            <div class="card-body">
                                                <p><b>TREESSH</b> &copy; <script> document.write(new Date().getFullYear())</script></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
