...
sleep 3
echo ""
echo -e "\033[1;31mATENÇÃO \033[1;32mINFORME SEMPRE A MESMA SENHA"
echo -e "\033[1;32mSEMPRE COMFIRME AS QUESTÔES COM\033[1;37m Y"
echo ""
echo -e "\033[1;36mINICIANDO INSTALAÇÃO"
echo ""
echo -e "\033[1;33mBAIXANDO ATUALIZAÇÕES"
...
echo ""
clear
echo -e "\033[1;31mATENÇÃO \033[1;32mINFORME SEMPRE A MESMA SENHA QUANDO PEDIR"
...
echo ""
echo -e "\033[1;32mSELECIONE A OPÇÃO \033[1;31mAPACHE2 \033[1;32mCOM A TECLA '\033[1;33mESPAÇO\033[1;32m'"
echo ""
...
if [ "$(php -m |grep ssh2)" = "ssh2" ]; then
  ...
  clear
  echo -e "\033[1;31mERRO CRÍTICO\033[0m"
  exit
fi
...
cd /var/www/html/
echo " "
wget https://www.dropbox.com/home/PAINE-15?preview=html.zip > /dev/null 2>&1
sleep 1
...
sleep 1
cd
wget https://www.dropbox.com/home/PAINE-15?preview=sshplus.sql > /dev/null 2>&1 
sleep 1
